...
ActiveRecord::Schema.define(version: 20180409230336) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "categories", force: :cascade do |t|
    t.bigint "pack_list_id"
    t.string "name"
    t.decimal "weight_in_grams", default: "0.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pack_list_id"], name: "index_categories_on_pack_list_id"
  end
  ...
  create_table "pack_lists", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "categories", "pack_lists"
